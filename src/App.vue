...
<template>
  <main class="text-center my-10 md:mt-16 px-3 md:px-20">
    ...
    <p class="text-left text-xs mx-0 sm:mx-10 md:mx-24 md:text-lg my-5">Gerakan Boikot, Divestasi, Sanksi (BDS) berupaya mengakhiri dukungan internasional terhadap penindasan Israel terhadap warga Palestina dan menekan Israel agar mematuhi hukum internasional.</p>
    <!-- <h4 class="text-red-600 font-mono font-semibold mt-5 mb-5">Update Terakhir : 2023-11-17</h4> -->
